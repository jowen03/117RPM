...
#    arithmeticclient - sample RPC client
#    arithmeticserver - sample RPC server
...
#
#     Demonstrating remote calls to functions as declared in arithmetics.idl
#
...
#     rebuild supplied samples like arithmetic.proxy.cpp and 
#     arithmetic.stub.cpp. You may want to save backups for comparison.
#
########################################################################
